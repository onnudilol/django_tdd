...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # Edith wonders whether the site will save her list.
        # Then she notices the site has generated a unique URL for her -- There is some explanatory text to that effect.
